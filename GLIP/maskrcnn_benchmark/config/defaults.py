...
# HJ add
_C.HJ = CN()
_C.HJ.SET_TRAIN = False # train using single object with multiple images data
_C.HJ.DATA_AS_SET = False # use image set data
_C.HJ.DATA_PER_SET = 10 # number of image per object
_C.HJ.RETURN_CENTERNESS = False # return centerness at generalized_vl_rcnn.py forward
_C.HJ.RIOU_LOSS = False # return riou loss at ATSSloss in loss.py __call__ function
_C.HJ.USE_ONLY_RIOU_LOSS = False
_C.HJ.NUM_LABEL = 1
_C.HJ.PART_NAMES = []
_C.HJ.CATEGORY_MIOU = 0.0
_C.HJ.USE_SOFTMAX = False
_C.HJ.USE_SIGMOID_WEIGHT = True
_C.HJ.USE_RELU_WEIGHT = False
_C.HJ.UPDATE_NULL_WEIGHT = False
_C.HJ.INIT_WEIGHT = 5.0
_C.HJ.UPDATE_CENTERNESS_NETWORK = False
_C.HJ.USE_PREBUILT_CENTERNESS = False