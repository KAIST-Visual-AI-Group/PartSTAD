...
class AnchorGenerator(nn.Module):
    ...
    def grid_anchors(self, grid_sizes):
        ...
        for size, stride, base_anchors in zip(
            ...
            # print((shifts.view(-1, 1, 4) + base_anchors.view(1, -1, 4)).reshape(-1, 4))
            # print((shifts.view(-1, 1, 4) + base_anchors.view(1, -1, 4)).reshape(-1, 4).shape)
            # input("ckpt!")
        return anchors
    ...
    def forward(self, image_list, feature_maps):
        grid_sizes = [feature_map.shape[-2:] for feature_map in feature_maps] # (100,100), (50,50), (25,25), (13,13), (7,7)
